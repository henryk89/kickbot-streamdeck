function SlowMode(inContext, inSettings) {
    console.log("slow mode init");
    let instance = this;
    Action.call(this, inContext, inSettings);

    this.onKeyUp = (inContext, inSettings, inCoordinates, inUserDesiredState, inState) => {
        console.log("slow mode keyDown");
        ...
        xhr.open('POST', 'https://6520-96-42-248-2.ngrok-free.app/api/sd_slow_mode', true);
